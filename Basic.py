...
try:
        ...
        #%%%%.        %                    +           ##             
         ...
         @@# *%%% .%@*     *@@@@@@@@@@:=      @*@=                    
            ...
            -@@@@@@@@@@@@@@@@#.  =@@@@@@@@@@@@%%@@@@#     -@@@@.      
             ...
             ____  ____     ____ ___  ____  _______  __  _  _    ___  _  _   
 | __ )|  _ \   / ___/ _ \|  _ \| ____\ \/ / | || |  / _ \| || |  
 |  _ \| | | | | |  | | | | | | |  _|  \  /  | || |_| | | | || |_ 
 | |_) | |_| | | |__| |_| | |_| | |___ /  \  |__   _| |_| |__   _|
 |____/|____/   \____\___/|____/|_____/_/\_\    |_|  \___/   |_|  
                                                                                                                             
                                                                      

    print("                         Tool Name: Automatic Basic Package installed")
    print("                           Developer: @BD CODEX")
    print(f'{yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
 ...
 .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  _________   | || |     _____    | || | ____  _____  | || |     _____    | || |    _______   | || |  ____  ____  | || |  _________   | || |  ________    | |
| | |_   ___  |  | || |    |_   _|   | || ||_   \|_   _| | || |    |_   _|   | || |   /  ___  |  | || | |_   ||   _| | || | |_   ___  |  | || | |_   ___ `.  | |
| |   | |_  \_|  | || |      | |     | || |  |   \ | |   | || |      | |     | || |  |  (__ \_|  | || |   | |__| |   | || |   | |_  \_|  | || |   | |   `. \ | |
| |   |  _|      | || |      | |     | || |  | |\ \| |   | || |      | |     | || |   '.___`-.   | || |   |  __  |   | || |   |  _|  _   | || |   | |    | | | |
| |  _| |_       | || |     _| |_    | || | _| |_\   |_  | || |     _| |_    | || |  |`\____) |  | || |  _| |  | |_  | || |  _| |___/ |  | || |  _| |___.' / | |
| | |_____|      | || |    |_____|   | || ||_____|\____| | || |    |_____|   | || |  |_______.'  | || | |____||____| | || | |_________|  | || | |________.'  | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
 ...
 ''')
    ...
    print("                       Developer: @BD CODEX")
    print(f"{cyan}                Telegram :: https://t.me/d3v1lj0k3r")
    print(f'{yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    print(f"{green}[+]-[Git].............................[ Installed ]")
    print(f"{green}[+]-[Python]..........................[ Installed ]")
    print(f"{green}[+]-[OpenSSL].........................[ Installed ]")
